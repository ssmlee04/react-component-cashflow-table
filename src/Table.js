      ...
      <table className='table table-sm'>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className='bg-lightgray-ultra-5'>{data[0] && data[0].operatingCashFlow && parseFloat(data[0].operatingCashFlow).toFixed(2)}</td>
            <td className='bg-lightgray-ultra-4'>{data[1] && data[1].operatingCashFlow && parseFloat(data[1].operatingCashFlow).toFixed(2)}</td>
            <td className='bg-lightgray-ultra-3'>{data[2] && data[2].operatingCashFlow && parseFloat(data[2].operatingCashFlow).toFixed(2)}</td>
            <td className='bg-lightgray-ultra-2'>{data[3] && data[3].operatingCashFlow && parseFloat(data[3].operatingCashFlow).toFixed(2)}</td>
          </tr>
          <tr>
