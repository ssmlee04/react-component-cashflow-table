...
export class CashflowTable extends React.Component {
  ...
  render() {
    const { profile, prop = 'cashflow_stmt', imgProp = 'cashflow_table', count = 4 } = this.props;
    ...
    return (
      <div style={{ width: '100%', padding: 5, fontSize: 12 }}>
        <div style={{ color: 'darkred', fontWeight: 'bold', marginBottom: 5, fontSize: 12 }}>{profile.ticker} - {profile.name} <span style={{ color: 'green' }}>Cashflow Statement</span></div>
