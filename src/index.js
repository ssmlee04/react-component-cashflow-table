  ...
  render() {
    ...
    return (
      <div style={{ width: '100%', padding: 5, fontSize: 8 }}>
        <div style={{ color: 'darkred', fontWeight: 'bold', marginBottom: 5, fontSize: 8 }}>{profile.ticker} - {profile.name} <span style={{ color: 'green' }}>Cashflow Statement</span></div>
        <Table data={data} />
        <div style={{ fontSize: 8, color: 'gray' }}>Generated by <span style={{ color: 'darkred' }}>@earningsfly</span> with <span style={{ fontSize: 8, color: 'red' }}>❤️</span></div>
      </div>
    );
  }
}
