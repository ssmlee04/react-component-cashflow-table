...
export class CashflowTable extends React.Component {
  ...
  render() {
    ...
    if (profile.cashflow_chart_img && profile.cashflow_chart_img.url) {
      ...
      return (
        <div className='react-components-show-button'>
          <img alt={`${profile.ticker} - ${profile.name} revenue and income margins`} src={profile.cashflow_chart_img.url} style={{ width: '100%' }} />
          <CopyToClipboard text={profile.cashflow_chart_img.url || ''}
